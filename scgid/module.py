...
class Module (object):
    ...
    # This method takes a dictionary or arguments typically read from a .yaml file (argdict) generated by SuperConfig.create_options_file()
    ...
    def translate_argdict(self, argdict, parser):
        ...
        for a in parser._actions:
            ...
            # This should be impossible because of`iter( set(itertools.chain(gct_vars, kmers_vars, codons_vars)) )` in SuperConfig.create_options_file()
