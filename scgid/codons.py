...
class Codons(Module, LoggingEntity, Head, ErrorHandler):
    ...
    def generate_argparser():
        ...
        parser.add_argument('-m','--gff3', dest="gff3", metavar='gene_models', action = "store", required = False, default = None, help ="A gff3 file from Augustus (one is generated by scgid blob) that contains the gene models for your metagenome.")
