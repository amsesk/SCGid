...
class Codons(Module, LoggingEntity, Head):
    ...
    def generate_argparser(self):
        ...
        parser.add_argument('-m','--gff3', metavar='gene_models', action = PathStore, required = False, default = None, help ="A gff3 file from Augustus (one is generated by scgid blob) that contains the gene models for your metagenome.")
        parser.add_argument('-n','--nucl', metavar='contig_fasta', action = PathStore, required = True, help ="The contig fasta associated with your metagenome.")
