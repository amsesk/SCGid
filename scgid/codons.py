...
class Codons(Module, LoggingEntity, Head, ErrorHandler):
    ...
    def generate_argparser():
        ...
        parser.add_argument('-e', '--evalue', metavar = 'e_value_cutoff', action = 'store', required = False, default = '1e-5', help = "The evalue cutoff for blast. Default: 1xe-5)")
