...
for lin in plotter.display_taxa:
    ...
    gc_counts,gc_div = np.histogram(plotter.infotable.df[plotter.infotable.df.pertinent_taxlvl == lin].gc, bins=1000)
    cov_counts,cov_div = np.histogram(plotter.infotable.df[plotter.infotable.df.pertinent_taxlvl == lin].log_coverage, bins=1000)
